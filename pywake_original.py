...
def wake(data, wt_x, wt_y, windTurbines, x_reg, y_reg,
    ...
    wf_model = PropagateDownwind(site, windTurbines,
                                        wake_deficitModel=BastankhahGaussianDeficit(use_effective_ws=True) #, shear = MOSTShear(h_ref=150, z0=.5, h_zeta=0.0, Cm1=5.0, Cm2=-19.3, interp_method='nearest'),
                                        )
...
if __name__ == '__main__':
    ...
    output_dir = '/scratch/project_2010671/DMI-HAMOWIOWF_temp/' + WFname + '/PyWake/original/' # where you want to put your output
    work_dir = 'code/'
    ...
    if (month == '202512') or (month == '202601') or (month == '202603') :
        ...
        raise ValueError(f"Month must be '202512', '202601', '202602', '202603' or '202604' ; not '{month}'.") 
    for j in list_j :
        for i in ['00', '03', '06', '09', '12', '15', '18', '21'] :
            ...
            ds_final = wake(data, wt_x, wt_y, windTurbines, x_reg, y_reg, height = 100)
